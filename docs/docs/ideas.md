...
Now that you have an idea how Facebook Messenger Platform, [Wit.ai](http://wit.ai), a simple Node.js App on Glitch and Airtable can work together to create conversational interfaces. Here are some ideas on what to do next:
